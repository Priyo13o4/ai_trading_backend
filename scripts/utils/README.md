...
**Usage:**
```bash
docker compose exec api python /app/scripts/utils/import_historical_csv.py
```
...
**Usage:**
```bash
docker compose exec api python /app/scripts/utils/pre_import_cleanup.py
```
...
**Usage:**
```bash
docker compose exec api python /app/scripts/utils/post_import_restoration.py
```
...
```bash
cd ai_trading_bot
./scripts/utils/master_reimport.sh
```
...
2. **Update symbol lists:**
   ```bash
   # In api/app/market_data.py
   SYMBOLS = ["XAUUSD", "EURUSD", "GBPUSD", "USDJPY", "AUDUSD", "USDCAD", "USDCHF", "NZDUSD"]
   
   # In scripts/realtime_updater.py
   SYMBOLS = ["XAUUSD", "EURUSD", "GBPUSD", "USDJPY", "AUDUSD", "USDCAD", "USDCHF", "NZDUSD"]
   
   # In scripts/fill_data_gaps.py
   SYMBOLS = ["XAUUSD", "EURUSD", "GBPUSD", "USDJPY", "AUDUSD", "USDCAD", "USDCHF", "NZDUSD"]
   ```
...
5. **Calculate indicators:**
   ```bash
   docker compose exec api python /app/scripts/calculate_recent_indicators.py
   ```
