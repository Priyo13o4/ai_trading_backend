...
#   docker compose exec api-worker bash /app/scripts/utils/master_reimport.sh
# ==============================================================================
...
# ==============================================================================
    3. Ensure api-worker scheduler is running to resume live data collection
# ==============================================================================
...
if [ "$INSIDE_DOCKER" = true ]; then
    python /app/scripts/utils/pre_import_cleanup.py
else
...
if [ "$INSIDE_DOCKER" = true ]; then
    ...
    docker compose run --rm \
        ...
        api-worker python /app/scripts/utils/import_historical_csv.py
fi
...
if [ "$INSIDE_DOCKER" = true ]; then
    python /app/scripts/utils/post_import_restoration.py
else
